...
|:-----------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------|
| [**Папка "infrastructure"**](./terraform/200_config/infrastructure)                                                          | Корневая папка Ansible                                               |
| [ansible.cfg](./terraform/200_config/infrastructure/ansible.cfg)                                                             | Параметры Ansible                                                    |
| [site.yaml](./terraform/200_config/infrastructure/site.yaml)                                                                 | Перечень файлов конфигурации для исполнения                          |
| [**Папка "inventory"**](./terraform/200_config/infrastructure/inventory)                                                     | Папка переменных                                                     |
| [hosts.yaml](./terraform/200_config/infrastructure/inventory/hosts.yaml)                                                     | Указание IP-адресов хостов                                           |
| [**Папка "inventory/group_vars/all"**](./terraform/200_config/infrastructure/inventory/group_vars/all)                       | Папка переменных, предназначенных группам хостов                     |
| [common.yaml](./terraform/200_config/infrastructure/inventory/group_vars/all/common.yaml)                                    | Переменные, не предполагаемые к изменению                            |
| [public_ips.yaml](./terraform/200_config/infrastructure/inventory/group_vars/all/public_ips.yaml)                            | Публичные IP хостов                                                  |
| [**Папка "playbooks"**](./terraform/200_config/infrastructure/playbooks)                                                     | Папка файлов конфигурации                                            |
| [deploy-apps.ansible.yaml](./terraform/200_config/infrastructure/playbooks/deploy-apps.ansible.yaml)                         | Загрузка инструментов для разворачивания кластера Kubernetes         |
| [deploy-dashboard.ansible.yaml](./terraform/200_config/infrastructure/playbooks/deploy-dashboard.ansible.yaml)               | Разворачивание графической панели Kubernetes                         |
| [grant-permissions.ansible.yaml](./terraform/200_config/infrastructure/playbooks/grant-permissions.ansible.yaml)             | Выдача разрешений на кластер                                         |
| [mount-cluster.ansible.yaml](./terraform/200_config/infrastructure/playbooks/mount-cluster.ansible.yaml)                     | Запуск Kubespray для разворачивания кластера                         |
| [nfs-provisioner-install.ansible.yaml](./terraform/200_config/infrastructure/playbooks/nfs-provisioner-install.ansible.yaml) | Разворачивание "nfs-server-provisioner"                              |
| [post-setup.ansible.yaml](./terraform/200_config/infrastructure/playbooks/post-setup.ansible.yaml)                           | Удаление временных файлов                                            |
| [pre-setup.ansible.yaml](./terraform/200_config/infrastructure/playbooks/pre-setup.ansible.yaml)                             | Заполнение файла параметров кластера<br/>и передача приватного ключа |
| [setup.ansible.yaml](./terraform/200_config/infrastructure/playbooks/setup.ansible.yaml)                                     | Установка инструментов кластера                                      |
| [**Папка "playbooks/k8s_cluster"**](./terraform/200_config/infrastructure/playbooks/k8s_cluster)                             | Шаблоны параметров кластера                                          |
| [k8s-cluster.yml](./terraform/200_config/infrastructure/playbooks/k8s_cluster/k8s-cluster.yml)                               | Шаблон параметров Kubernetes                                         |
| [k8s-net-calico.yml](./terraform/200_config/infrastructure/playbooks/k8s_cluster/k8s-net-calico.yml)                         | Шаблон параметров Calico                                             |
| [**Папка "playbooks/templates"**](./terraform/200_config/infrastructure/playbooks/templates)                                 | Компоненты кластера                                                  |
| [admin-user-rbac.yaml](./terraform/200_config/infrastructure/playbooks/templates/admin-user-rbac.yaml)                       | ClusterRoleBinding администратора                                    |
| [admin-user-sa.yaml](./terraform/200_config/infrastructure/playbooks/templates/admin-user-sa.yaml)                           | ServiceAccount администратора                                        |
| [dashboard.yaml](./terraform/200_config/infrastructure/playbooks/templates/dashboard.yaml)                                   | Компоненты графической панели Kubernetes                             |
| [deploy-pg.yaml](./terraform/200_config/infrastructure/playbooks/templates/deploy-pg.yaml)                                   | Разворачивание StatefulSet БД PostgreSQL                             |
| [deployment.ansible.yaml](./terraform/200_config/infrastructure/playbooks/templates/deployment.ansible.yaml)                 | Deployment экземпляра Nginx                                          |
| [empty-dir.ansible.yaml](./terraform/200_config/infrastructure/playbooks/templates/empty-dir.ansible.yaml)                   | Pod экземпляра Nginx                                                 |
| [hosts.ansible.yaml.j2](./terraform/200_config/infrastructure/playbooks/templates/hosts.ansible.yaml.j2)                     | Шаблон параметров кластера                                           |
| [pg-pv.yaml](./terraform/200_config/infrastructure/playbooks/templates/pg-pv.yaml)                                           | PersistentVolume                                                     |
| [**Папка "playbooks/back-and-front"**](./terraform/200_config/infrastructure/playbooks/templates/back-and-front)             | Папка веб-приложения                                                 |
| [deploy-backend.yaml](./terraform/200_config/infrastructure/playbooks/templates/back-and-front/deploy-backend.yaml)          | Бэкенд приложения                                                    |
| [deploy-frontend.yaml](./terraform/200_config/infrastructure/playbooks/templates/back-and-front/deploy-frontend.yaml)        | Фронтенд приложения                                                  |
| [ingress.yaml](./terraform/200_config/infrastructure/playbooks/templates/back-and-front/ingress.yaml)                        | Ingress-правила                                                      |
| [**Папка "playbooks/debug"**](./terraform/200_config/infrastructure/playbooks/templates/debug)                               | Папка вспомогательных инструментов                                   |
| [dnsutils.ansible.yaml](./terraform/200_config/infrastructure/playbooks/templates/debug/dnsutils.ansible.yaml)               | Набор DNS-утилит                                                     |
| [minipg.ansible.yaml](./terraform/200_config/infrastructure/playbooks/templates/debug/minipg.ansible.yaml)                   | Клиент БД PostgreSQL                                                 |
...
Подготовим простейшее [тестовое веб-приложение](./web-app), состоящее из
единственной [html-страницы](./web-app/index.html), отображающей некоторые сведения:
...
![github_diploma_repo.png](images%2Fgithub_diploma_repo.png)
...
![dockerhub_diploma_image_v001.png](images%2Fdockerhub_diploma_image_v001.png)
