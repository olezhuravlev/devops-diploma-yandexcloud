...
yc-folder-id = "b1g35alosoaq6u8qvmtj"
...
|          ID          |     NAME     |
+----------------------+--------------+
| aje9rb4oq20vn4vf61us | terraform-sa |
+----------------------+--------------+
````
...
access_key:
  id: ajerrp30c13tdho0n85p
  service_account_id: aje9rb4oq20vn4vf61us
  created_at: "2023-01-19T05:55:15.748940060Z"
  key_id: YCAJEC21b38H5nmElBaiLiGqY
secret: YCNFqsutDhbB94drg_orvFaED1JEXRgfJxBTBxIM
````
...
Запустим наши виртуальные машины Yandex.Cloud, дождёмся назначения им внешних IP-адресов и укажем эти адреса
в специально предназначенном для них конфигурационном файле
...
default                pod/nfs-server-nfs-server-provisioner-0         1/1     Running   0             4m54s   10.200.104.3     node2   <none>           <none>
kube-system            pod/calico-kube-controllers-7f679c5d6f-g2lmk    1/1     Running   0             7m50s   10.200.104.1     node2   <none>           <none>
kube-system            pod/calico-node-hhvbc                           1/1     Running   0             8m39s   10.30.30.1       node2   <none>           <none>
kube-system            pod/calico-node-kp42w                           1/1     Running   0             8m39s   10.20.20.1       node1   <none>           <none>
kube-system            pod/calico-node-kws54                           1/1     Running   0             8m39s   10.10.10.1       cp1     <none>           <none>
kube-system            pod/coredns-5867d9544c-dnf9p                    1/1     Running   0             7m29s   10.200.176.1     cp1     <none>           <none>
kube-system            pod/coredns-5867d9544c-dxvfx                    1/1     Running   0             7m22s   10.200.166.129   node1   <none>           <none>
kube-system            pod/dns-autoscaler-59b8867c86-b25m2             1/1     Running   0             7m25s   10.200.176.2     cp1     <none>           <none>
kube-system            pod/kube-apiserver-cp1                          1/1     Running   1             10m     10.10.10.1       cp1     <none>           <none>
kube-system            pod/kube-controller-manager-cp1                 1/1     Running   2 (10m ago)   10m     10.10.10.1       cp1     <none>           <none>
kube-system            pod/kube-proxy-fnhxp                            1/1     Running   0             9m17s   10.10.10.1       cp1     <none>           <none>
kube-system            pod/kube-proxy-m4hd7                            1/1     Running   0             9m17s   10.20.20.1       node1   <none>           <none>
kube-system            pod/kube-proxy-ttrhf                            1/1     Running   0             9m17s   10.30.30.1       node2   <none>           <none>
kube-system            pod/kube-scheduler-cp1                          1/1     Running   1             10m     10.10.10.1       cp1     <none>           <none>
kube-system            pod/nginx-proxy-node1                           1/1     Running   0             8m2s    10.20.20.1       node1   <none>           <none>
kube-system            pod/nginx-proxy-node2                           1/1     Running   0             8m20s   10.30.30.1       node2   <none>           <none>
kube-system            pod/nodelocaldns-65kc2                          1/1     Running   0             7m22s   10.20.20.1       node1   <none>           <none>
kube-system            pod/nodelocaldns-d782c                          1/1     Running   0             7m22s   10.30.30.1       node2   <none>           <none>
kube-system            pod/nodelocaldns-m5jfr                          1/1     Running   0             7m22s   10.10.10.1       cp1     <none>           <none>
kubernetes-dashboard   pod/dashboard-metrics-scraper-8c47d4b5d-sznld   1/1     Running   0             5m42s   10.200.166.130   node1   <none>           <none>
kubernetes-dashboard   pod/kubernetes-dashboard-6c75475678-hwvq9       1/1     Running   0             5m42s   10.200.104.2     node2   <none>           <none>

NAMESPACE              NAME                                        TYPE        CLUSTER-IP      EXTERNAL-IP   PORT(S)                                                                                                     AGE     SELECTOR
default                service/kubernetes                          ClusterIP   10.32.0.1       <none>        443/TCP                                                                                                     10m     <none>
default                service/nfs-server-nfs-server-provisioner   ClusterIP   10.32.103.169   <none>        2049/TCP,2049/UDP,32803/TCP,32803/UDP,20048/TCP,20048/UDP,875/TCP,875/UDP,111/TCP,111/UDP,662/TCP,662/UDP   4m55s   app=nfs-server-provisioner,release=nfs-server
kube-system            service/coredns                             ClusterIP   10.32.0.3       <none>        53/UDP,53/TCP,9153/TCP                                                                                      7m30s   k8s-app=kube-dns
kubernetes-dashboard   service/dashboard-metrics-scraper           ClusterIP   10.32.154.57    <none>        8000/TCP                                                                                                    5m43s   k8s-app=dashboard-metrics-scraper
kubernetes-dashboard   service/kubernetes-dashboard                ClusterIP   10.32.233.215   <none>        443/TCP                                                                                                     5m44s   k8s-app=kubernetes-dashboard

NAMESPACE     NAME                          DESIRED   CURRENT   READY   UP-TO-DATE   AVAILABLE   NODE SELECTOR            AGE     CONTAINERS    IMAGES                                          SELECTOR
kube-system   daemonset.apps/calico-node    3         3         3       3            3           kubernetes.io/os=linux   8m41s   calico-node   quay.io/calico/node:v3.24.5                     k8s-app=calico-node
kube-system   daemonset.apps/kube-proxy     3         3         3       3            3           kubernetes.io/os=linux   10m     kube-proxy    registry.k8s.io/kube-proxy:v1.24.4              k8s-app=kube-proxy
kube-system   daemonset.apps/nodelocaldns   3         3         3       3            3           kubernetes.io/os=linux   7m24s   node-cache    registry.k8s.io/dns/k8s-dns-node-cache:1.21.1   k8s-app=nodelocaldns

NAMESPACE              NAME                                        READY   UP-TO-DATE   AVAILABLE   AGE     CONTAINERS                  IMAGES                                                            SELECTOR
kube-system            deployment.apps/calico-kube-controllers     1/1     1            1           7m52s   calico-kube-controllers     quay.io/calico/kube-controllers:v3.24.5                           k8s-app=calico-kube-controllers
kube-system            deployment.apps/coredns                     2/2     2            2           7m32s   coredns                     registry.k8s.io/coredns/coredns:v1.9.3                            k8s-app=kube-dns
kube-system            deployment.apps/dns-autoscaler              1/1     1            1           7m29s   autoscaler                  registry.k8s.io/cpa/cluster-proportional-autoscaler-amd64:1.8.5   k8s-app=dns-autoscaler
kubernetes-dashboard   deployment.apps/dashboard-metrics-scraper   1/1     1            1           5m43s   dashboard-metrics-scraper   kubernetesui/metrics-scraper:v1.0.8                               k8s-app=dashboard-metrics-scraper
kubernetes-dashboard   deployment.apps/kubernetes-dashboard        1/1     1            1           5m43s   kubernetes-dashboard        kubernetesui/dashboard:v2.6.1                                     k8s-app=kubernetes-dashboard

NAMESPACE              NAME                                                  DESIRED   CURRENT   READY   AGE     CONTAINERS                  IMAGES                                                            SELECTOR
kube-system            replicaset.apps/calico-kube-controllers-7f679c5d6f    1         1         1       7m52s   calico-kube-controllers     quay.io/calico/kube-controllers:v3.24.5                           k8s-app=calico-kube-controllers,pod-template-hash=7f679c5d6f
kube-system            replicaset.apps/coredns-5867d9544c                    2         2         2       7m32s   coredns                     registry.k8s.io/coredns/coredns:v1.9.3                            k8s-app=kube-dns,pod-template-hash=5867d9544c
kube-system            replicaset.apps/dns-autoscaler-59b8867c86             1         1         1       7m29s   autoscaler                  registry.k8s.io/cpa/cluster-proportional-autoscaler-amd64:1.8.5   k8s-app=dns-autoscaler,pod-template-hash=59b8867c86
kubernetes-dashboard   replicaset.apps/dashboard-metrics-scraper-8c47d4b5d   1         1         1       5m43s   dashboard-metrics-scraper   kubernetesui/metrics-scraper:v1.0.8                               k8s-app=dashboard-metrics-scraper,pod-template-hash=8c47d4b5d
kubernetes-dashboard   replicaset.apps/kubernetes-dashboard-6c75475678       1         1         1       5m43s   kubernetes-dashboard        kubernetesui/dashboard:v2.6.1                                     k8s-app=kubernetes-dashboard,pod-template-hash=6c75475678

NAMESPACE   NAME                                                 READY   AGE     CONTAINERS               IMAGES
default     statefulset.apps/nfs-server-nfs-server-provisioner   1/1     4m55s   nfs-server-provisioner   quay.io/kubernetes_incubator/nfs-provisioner:v2.3.0

NAMESPACE              NAME                                           DATA   AGE
default                configmap/kube-root-ca.crt                     1      10m
kube-node-lease        configmap/kube-root-ca.crt                     1      10m
kube-public            configmap/cluster-info                         5      10m
kube-public            configmap/kube-root-ca.crt                     1      10m
kube-system            configmap/calico-config                        2      8m42s
kube-system            configmap/coredns                              1      7m32s
kube-system            configmap/dns-autoscaler                       1      7m23s
kube-system            configmap/extension-apiserver-authentication   6      10m
kube-system            configmap/kube-proxy                           2      10m
kube-system            configmap/kube-root-ca.crt                     1      10m
kube-system            configmap/kubeadm-config                       1      10m
kube-system            configmap/kubelet-config                       1      10m
kube-system            configmap/kubernetes-services-endpoint         0      8m37s
kube-system            configmap/nodelocaldns                         1      7m25s
kubernetes-dashboard   configmap/kube-root-ca.crt                     1      5m44s
kubernetes-dashboard   configmap/kubernetes-dashboard-settings        0      5m44s

NAMESPACE              NAME                                                        ENDPOINTS                                                          AGE
default                endpoints/cluster.local-nfs-server-nfs-server-provisioner   <none>                                                             4m36s
default                endpoints/kubernetes                                        10.10.10.1:6443                                                    10m
default                endpoints/nfs-server-nfs-server-provisioner                 10.200.104.3:20048,10.200.104.3:662,10.200.104.3:111 + 9 more...   4m55s
kube-system            endpoints/coredns                                           10.200.166.129:53,10.200.176.1:53,10.200.166.129:53 + 3 more...    7m30s
kubernetes-dashboard   endpoints/dashboard-metrics-scraper                         10.200.166.130:8000                                                5m43s
kubernetes-dashboard   endpoints/kubernetes-dashboard                              10.200.104.2:8443                                                  5m44s
````
...
Создаём копию файла [example.jsonnet](./example.jsonnet) под
...
Создаём пространства имен и CRD (Custom Resource
...
Ожидаем запуска всех ресурсов и выполняем вторую часть - запускаем ресурсы, непосредственно реализующие систему
мониторинга:
...
![web_app_30000.png](images%2Fweb_app_30000.png)

Список развернутых с помощью "Helm" приложений возно вывести командой:

````bash
$ helm list                   
NAME            NAMESPACE       REVISION        UPDATED                                 STATUS          CHART                           APP VERSION
nfs-server      default         1               2023-01-19 06:42:05.296269109 +0000 UTC deployed        nfs-server-provisioner-1.1.3    2.3.0      
web-app         default         1               2023-01-19 09:58:11.721129899 +0100 CET deployed        web-app-0.0.1                   0.0.1    
````

#### Размещение созданного приложения в репозитории Helm
...
![artifacthub_repos.png](images%2Fartifacthub_repos.png)

В параметрах репозитория указываем его имя и URL,  

![artifacthub_repo_add.png](images%2Fartifacthub_repo_add.png)
...
обновить версию приложения в репозитории. Для этого в файлах [values.yaml](./helm/web-app/values.yaml) и
[Chart.yaml](./helm/web-app/Chart.yaml) изменяем номер версии на следующий и снова создаём архив приложения:

````bash
$ helm package web-app -d charts/
Successfully packaged chart and saved it to: charts/web-app-0.0.2.tgz
````

После этого обновляем индексный файл [index.yaml](./helm/charts/index.yaml):
````bash
$ helm repo index charts/
````

Следующим важным шагом является то, что т.к. мы обновили версию нашего приложения, изменив её в файле
[values.yaml](./helm/web-app/values.yaml) c `0.0.1` на `0.0.2`, то и из Docker-репозитория, где хранится образ
нашего приложения, также будет затребована версия `0.0.2`, а не `0.0.1`.
Т.е. команда на получение образа будет иметь вид `docker pull olezhuravlev/diploma:0.0.2`.
Соответственно, нам необходимо новую версию разместить и в Docker-репозитории.

Мы не будем как-то изменять эту версию по содержанию, а просто разместим эту же версию приложения с новым тегом.
...
Присвоим этой версии образа новый тег `0.0.2`:

````bash
$ docker tag olezhuravlev/diploma:0.0.1 olezhuravlev/diploma:0.0.2

$ docker image ls
REPOSITORY                                TAG          IMAGE ID       CREATED         SIZE
olezhuravlev/diploma                      0.0.2        28f4b7049a10   1 day ago       142MB
olezhuravlev/diploma                      0.0.1        28f4b7049a10   2 days ago      142MB
````

Как видим по идентификатору образа, это один и тот же образ, но с другим тегом, отражающим номер версии.
Отправляем новую версию в Docker-репозиторий:

````bash
$ docker push olezhuravlev/diploma:0.0.2
The push refers to repository [docker.io/olezhuravlev/diploma]
7e46b64469bd: Layer already exists 
f1b7541425c2: Layer already exists 
...
0.0.2: digest: sha256:a99757f9eb9cb6056aec64200fd35e721bf1130616357230da4ed9aa207b7486 size: 1984
````

Как видим, не изменилось вообще ничего, помимо тега, а новая версия появилась в репозитории:

![dockerhub_v002.png](images%2Fdockerhub_v002.png)

> Если версию в Docker-репозитории не обновить, то Helm-репозиторий заботливо предупредит нас об этом, выведя в поле
> "SECURITY SCAN" предупреждение, что указанный образ не найден:
>
> ![github_helm_repo_image_not_found.png](images%2Fgithub_helm_repo_image_not_found.png)

Создан новый архив, обновлен индесный файл и тег образа в Docker-репозитории. Теперь отправляем все изменения,
касающиеся Helm-репозитория, в привязанный к нему репозиторий на Github:

![github_helm_repo2.png](./images/github_helm_repo2.png)

> Как видим, в Github-репозитории оказалось уже две версии нашего приложения - удалять старые версии нельзя, потому что
> они уже могут быть в работе у пользователей репозитория.
...
файл [index.yaml](./helm/charts/index.yaml) обновлён, перечитает наш репозиторий, обнаружит в нём
[файл метаданных](./helm/charts/artifacthub-repo.yml) и присвоит нашему репозиторию
почётный статус "Verified Publisher":

![github_helm_repo2_verified.png](images%2Fgithub_helm_repo2_verified.png)
...
Проверим работоспособность схемы установки нашего веб-приложения из репозитория "Helm". Для этого сперва удалим
действующее приложение из кластера:

````bash
$ kubectl delete deploy/web-app -n default                          
deployment.apps "web-app" deleted
````

И заново установим его же, но уже из репозитория, используя созданный нами Ansible-манифест
...
ok: [cp1]
TASK [Deploy latest version of web-application] **********
changed: [cp1]
PLAY RECAP ***********************************************
...
Общее количество подов в кластере:
````bash
...
![prometheus_queries.png](images%2Fprometheus_queries.png)
...
![grafana_panel1.png](images%2Fgrafana_panel1.png)

Панель, отображающая долю работающих подов кластера, и долю работающих подов веб-приложения:

![grafana_panel2.png](images%2Fgrafana_panel2.png)
...
Grafana+Prometheus:
/run/media/oleg/Second/Netology/devops-14/10-monitoring-03-grafana/README.md

Helm:
/run/media/oleg/Second/Netology/devops-14/13-kubernetes-config-04-helm/13-kubernetes-config-04-helm.md

#### Теперь подключим микросервисы, экспортирующие метрики второй виртуальной машины, к Prometheus первой виртуальной машины.

1. Зайдем через SSH-терминал на первую виртуальную машину и добавим в конфигурационный
   файл `/opt/stack/prometheus/prometheus.yml` сведения о новых поставщиках данных:
...
####* Как видим, запрос принят, но, на самом деле, перезагрузки не происходит, даже несмотря на установленный при
запуске контейнера Prometheus флаг `--web.enable-lifecycle` и приходится перезапускать или контейнер, или сервер, чтобы
