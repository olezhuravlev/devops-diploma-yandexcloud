...
[сервер и агент Teamcity](/run/media/oleg/Second/Netology/devops-diploma-yandexcloud/16-diploma-yc/ansible/infrastructure/playbooks/deploy-tc.ansible.yaml).
